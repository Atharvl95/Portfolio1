  ...
  useEffect(() => {
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        const csX = cursorSize * cellScale.x; const csY = cursorSize * cellScale.y;
        ...
        uniforms.force.value.set(forceX, forceY); uniforms.center.value.set(centerX, centerY);
        uniforms.scale.value.set(cursorSize, cursorSize); super.update();
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: any[]) {
        const { viscous: v, iterations, dt: d } = (args[0] || {}) as any;
        if (!this.uniforms) return;
    ...
    class Pressure extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (this.uniforms && vel && pressure) {
          this.uniforms.velocity.value = vel.texture; this.uniforms.pressure.value = pressure.texture;
        }
        super.update();
      }
    }
